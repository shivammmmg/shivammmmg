...
I’m a **Software Engineering student** with a builder mindset. I love turning real-world ideas into code + systems.

My foundation is in **embedded systems**, **digital logic**, and **control**, where timing, constraints, and hardware meet software.

I value **clarity, clean code, and depth** over surface-level hype. I build with purpose, not just tutorials.
...
- [🏆 YorkU Conference Room Scheduler](https://github.com/shivammmmg/ConferenceRoomSchedulerYorkU)  
  Java-based desktop app for booking conference rooms with role-based access and clean UI.

- [🚦 Smart Traffic Light Controller (FPGA)](https://github.com/shivammmmg/Smart-Traffic-Light-Controller-FPGA)  
  FSM-based traffic controller for DE10-Lite with pedestrian handling and night mode.

- [📡 Ultrasonic Radar System](https://github.com/shivammmmg/ULTRASONIC-RADAR)  
  Radar-style distance & angle sensing with dynamic MATLAB visualization.

- [🌆 Urban Environmental Monitoring System](https://github.com/shivammmmg/Smart-Urban-Environmental-Monitoring-System)  
  IoT-based real-time sensor monitoring with a Java-powered dashboard.
